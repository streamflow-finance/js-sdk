  ...
  "instructions": [
    {
      ...
      "docs": [
        "Claim allocated funds instantly in case vesting schedule is not set"
      ],
      "discriminator": [
        49,
        89,
      ...
      "accounts": [
        ...
        },
        {
          "name": "to",
          "docs": [
            "Token Account to which tokens will be transferred"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "docs": [
        "Claim allocated funds in a vested manner in case vesting schedule has been set"
      ],
      "discriminator": [
        14,
        116,
      ...
      "accounts": [
        ...
        },
        {
          "name": "to",
          "docs": [
            "Token Account to which tokens will be vested"
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "rent",
          "docs": [
            "Rent account required by streamflow protocol"
          ],
    ...
    },
    {
      "name": "claimDeposits",
      "docs": [
        "Claim deposited funds to pre-configured `receiver` account"
      ],
      "discriminator": [
        69,
        159,
      ...
      "accounts": [
        ...
        },
        {
          "name": "receiver",
          "docs": [
            "Deposits receiver token account"
          ],
          "writable": true,
          "relations": [
            "launchpad"
        ...
        },
        {
          "name": "vault",
          "docs": [
            "Launchpad Vault that stores deposited tokens"
          ],
          "writable": true,
          "relations": [
            "launchpad"
    ...
    },
    {
      ...
      "docs": [
        "Create new Launchpad for `base_mint` <-> `quote_mint` pair"
      ],
      "discriminator": [
        193,
        189,
      ...
      "accounts": [
        ...
        },
        {
          "name": "vault",
          "docs": [
            "Escrow Account that will store deposits"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      "name": "deposit",
      "docs": [
        "Deposit funds to receive allocation"
      ],
      "discriminator": [
        242,
        35,
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            ...
            "docs": [
              "Individual Depositing Cap in `quote_mint` Tokens"
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "Max Depositing Cap in `quote_mint` Tokens"
            ],
            "type": "u64"
          },
          {
          ...
          },
          {
            "name": "minPercentage",
            "docs": [
              "Min percentage for dynamic vesting"
            ],
            "type": "u64"
          },
          {
            "name": "maxPercentage",
            "docs": [
              "Max percentage for dynamic vesting"
            ],
            "type": "u64"
          },
          {
            "name": "tickSize",
            "docs": [
              "Size of the tick in dynamic vesting"
            ],
            "type": "u64"
          },
          {
            "name": "skipInitial",
            "docs": [
              "Whether to skip initial calculation of amount per period in dynamic vesting"
            ],
            "type": "bool"
          },
          {
          ...
          },
          {
            "name": "isMemoRequired",
            "docs": [
              "Whether to require memo on deposit"
            ],
            "type": "bool"
          }
        ]
        ...
        "fields": [
          {
            "name": "launchpad",
            "docs": [
              "Launchpad to which deposit belongs"
            ],
            "type": "pubkey"
          },
          {
          ...
          },
          {
            "name": "amount",
            "docs": [
              "Amount of funds deposited in `quote_mint`"
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "Amount allocated according to amount deposited"
            ],
            "type": "u64"
          },
          {
            "name": "createdTs",
            "docs": [
              "Time when deposit was done initially"
            ],
            "type": "u64"
          },
          {
            "name": "claimedTs",
            "docs": [
              "Time when `allocated_amount` was claimed"
            ],
            "type": "u64"
          },
          {
        ...
        "fields": [
          {
            "name": "amount",
            "docs": [
              "Amount to deposit into the launchpad"
            ],
            "type": "u64"
          },
          {
            "name": "autoCap",
            "docs": [
              "Whether to allow automatically cap the amount in case amount exceeds `max_depositing_cap`"
            ],
            "type": "bool"
          }
        ]
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "filler",
            "docs": [
              "Filler to account for alignment"
            ],
            "type": {
              "array": [
                "u8",
          ...
          },
          {
            "name": "quoteMint",
            "docs": [
              "Mint of the Token to exchange base mint to"
            ],
            "type": "pubkey"
          },
          {
          ...
          },
          {
            "name": "receiver",
            "docs": [
              "Token account that should receive deposits after launchpad deposits end"
            ],
            "type": "pubkey"
          },
          {
            "name": "priceOracle",
            "docs": [
              "Oracle account for price deriviation in vesting"
            ],
            "type": "pubkey"
          },
          {
            "name": "vault",
            "docs": [
              "Escrow Account that stores deposited tokens"
            ],
            "type": "pubkey"
          },
          {
        ...
        "fields": [
          {
            ...
            "docs": [
              "Total amount of `quote_mint` tokens deposited"
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "Total amount of users who deposited tokens"
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "Number of users who have claimed `base_mint` tokens already"
            ],
            "type": "u64"
          },
          {
            "name": "createdTs",
            "docs": [
              "Time when Launchpad was created"
            ],
            "type": "u64"
          },
          {
            "name": "claimedTs",
            "docs": [
              "Time when deposits where claimed to authority token account"
            ],
            "type": "u64"
          },
          {
            "name": "cancelledTs",
            "docs": [
              "Time when Launchpad was cancelled, makes withdrawals possible"
            ],
            "type": "u64"
          },
          {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "period",
            "docs": [
              "Vesting unlock/update period in seconds"
            ],
            "type": "u64"
          },
          {
