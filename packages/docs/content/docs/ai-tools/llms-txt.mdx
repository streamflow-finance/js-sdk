...
# Single page
curl https://developers.streamflow.finance/docs/core-concepts/streams/composable-apis/create-lock.mdx
...
<Callout type="info">
  `/llms.txt` follows the [llms.txt standard](https://llmstxt.org/) - a convention for making documentation
  machine-readable for AI tools.
</Callout>
