 ...
 * Stream layout
 */
export const streamLayout: BufferLayout.Structure<IStreamLayout> =
  BufferLayout.struct([
...
export const partnerLayout: BufferLayout.Structure<IPartnerLayout> =
  BufferLayout.struct([
 ...
 */
export const createStreamLayout: BufferLayout.Structure<ICreateStreamLayout> =
  BufferLayout.struct([
    BufferLayout.blob(8, "start_time"),
    BufferLayout.blob(8, "net_amount_deposited"),
    BufferLayout.blob(8, "period"),
 ...
 */
export const encodeUpdateStream = (
  values: IUpdateStreamLayout,
  data: Buffer
): number => {
  ...
  return BufferLayout.struct<any>(structs).encode(
    {
      enable_automatic_withdrawal_exists: values.enable_automatic_withdrawal
        ? 1
        : 0,
 ...
 */
export const topupStreamLayout: BufferLayout.Structure<ITopupStreamLayout> =
  BufferLayout.struct([BufferLayout.blob(8, "amount")]);
