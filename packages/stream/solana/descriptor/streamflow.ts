...
export type Streamflow = {
  ...
  instructions: [
    ...
    {
      name: 'claimRoutedFee';
      discriminator: [21, 196, 95, 101, 117, 238, 89, 30];
      accounts: [
        {
          name: 'authority';
          signer: true;
    ...
    },
    {
      ...
      discriminator: [174, 205, 227, 30, 140, 186, 80, 195];
      accounts: [
        {
          name: 'sender';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [224, 111, 138, 71, 113, 197, 168, 104];
      accounts: [
        {
          name: 'sender';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [0, 123, 85, 155, 20, 111, 159, 22];
      accounts: [
        {
          name: 'payer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [1, 244, 255, 246, 255, 170, 153, 94];
      accounts: [
        {
          name: 'payer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [235, 246, 224, 64, 105, 166, 20, 138];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    {
      name: 'transferSender';
      discriminator: [164, 145, 241, 243, 109, 58, 215, 239];
      accounts: [
        {
          name: 'sender';
          signer: true;
