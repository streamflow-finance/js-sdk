...
export const EVM_ERROR_MAP = {
  ...
  EBAD_INSUFFICIENT_TOKEN_ALLOWANCE:
    ContractErrorCode.EBAD_INSUFFICIENT_TOKEN_ALLOWANCE,
  EBAD_INSUFFICIENT_WITHDRAWAL_FEES:
    ContractErrorCode.EBAD_INSUFFICIENT_WITHDRAWAL_FEES,
};
