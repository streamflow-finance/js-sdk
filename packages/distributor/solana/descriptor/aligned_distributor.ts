    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "alignedDistributor",
          "docs": [
            "The account holding the proxy parameters.",
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "distributor",
          "docs": [
            "The account holding the vesting parameters.",
          ],
          "writable": true
        },
        {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "updatePeriod",
            "docs": [
              "Period of updates, can be different from unlock period if needed",
            ],
            "type": "u64"
          },
          {
          ...
          },
          {
            "name": "startTs",
            "docs": [
              "Copy start ts from the Distributor to be used in the worker",
            ],
            "type": "u64"
          },
          {
            "name": "endTs",
            "docs": [
              "Copy end ts from the Distributor to be used in the worker",
            ],
            "type": "u64"
          },
          {
          ...
          },
          {
            ...
            "docs": [
              "Initial Airdrop Vesting duration",
            ],
            "type": "u64"
          },
          {
          ...
          },
          {
            ...
            "docs": [
              "Whether distributor was clawed backed",
            ],
            "type": "bool"
          },
          {
            "name": "mint",
            "docs": [
              "Mint for which the distributor was created",
            ],
            "type": "pubkey"
          },
          {
