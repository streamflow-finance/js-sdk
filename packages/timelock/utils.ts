...
export const formatDecodedStream = (stream: DecodedStream): Stream => ({
  ...
  senderTokens: stream.senderTokens,
  recipient: stream.recipient.toBase58(),
  recipientTokens: stream.recipientTokens,
  mint: stream.mint.toBase58(),
  escrowTokens: stream.escrowTokens,
  streamflowTreasury: stream.streamflowTreasury,
  streamflowTreasuryTokens: stream.streamflowTreasuryTokens,
  streamflowFeeTotal: stream.streamflowFeeTotal,
  streamflowFeeWithdrawn: stream.streamflowFeeWithdrawn,
  streamflowFeePercent: stream.streamflowFeePercent,
  ...
  partnerTokens: stream.partnerTokens,
