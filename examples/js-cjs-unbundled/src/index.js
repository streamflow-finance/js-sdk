/**
 * Example of using Streamflow SDK with JavaScript, CommonJS, and no bundler
 *
 * This example demonstrates:
 * 1. Importing multiple Streamflow SDK packages using CommonJS imports in JavaScript
...
async function main() {
  console.log("Streamflow SDK Example: JavaScript, CommonJS, Unbundled");
