...
var TokenStreamDataLayout = buffer_layout_1.default.struct([
  ...
  buffer_layout_1.default.blob(1, "version"),
  ...
  buffer_layout_1.default.blob(32, "streamflow_treasury"),
  buffer_layout_1.default.blob(32, "streamflow_treasury_tokens"),
  buffer_layout_1.default.blob(8, "streamflow_fee_total"),
  buffer_layout_1.default.blob(8, "streamflow_fee_withdrawn"),
  buffer_layout_1.default.blob(4, "streamflow_fee_percent"),
  buffer_layout_1.default.blob(32, "partner"),
  buffer_layout_1.default.blob(32, "partner_tokens"),
  buffer_layout_1.default.blob(8, "partner_fee_total"),
  buffer_layout_1.default.blob(8, "partner_fee_withdrawn"),
  buffer_layout_1.default.blob(4, "partner_fee_percent"),
...
function decode(buf) {
  ...
  return {
    ...
    version: new anchor_1.BN(raw.version, LE),
    ...
    streamflow_treasury: new web3_js_1.PublicKey(raw.streamflow_treasury),
    streamflow_treasury_tokens: new web3_js_1.PublicKey(
      raw.streamflow_treasury_tokens
    ),
    streamflow_fee_total: new anchor_1.BN(raw.streamflow_fee_total, LE),
    streamflow_fee_withdrawn: new anchor_1.BN(raw.streamflow_fee_withdrawn, LE),
    streamflow_fee_percent: new anchor_1.BN(raw.streamflow_fee_percent, LE),
    partner_fee_total: new anchor_1.BN(raw.partner_fee_total, LE),
    partner_fee_withdrawn: new anchor_1.BN(raw.partner_fee_withdrawn, LE),
    partner_fee_percent: new anchor_1.BN(raw.partner_fee_percent, LE),
    partner: new web3_js_1.PublicKey(raw.partner),
    partner_tokens: new web3_js_1.PublicKey(raw.partner_tokens),
